...
Route::get('/unsubscribe/{token}', [Subscription::class, 'unsubscribe'])->name('unsubscribe');
Route::post('/unsubscribe/{token}', [Subscription::class, 'unsubscribeMail'])->name('unsubscribe.email');
