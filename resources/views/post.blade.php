...
<section class="w-full md:w-3/4 flex flex-col items-center px-3">
    ...
    TOO
        ...
        <a href="#" class="hover:opacity-75">
            <img src="https://source.unsplash.com/collection/1346951/1000x500?sig=1" alt="article_image" width="1280" height="720">
        </a>
    ...
    <article class="flex flex-col shadow my-4">
        <!-- Article Image -->
        <a href="#" class="hover:opacity-75">
            <img src="https://source.unsplash.com/collection/1346951/1000x500?sig=2" alt="article_image" width="1280" height="720">
        </a>
        <div class="bg-white flex flex-col justify-start p-6">
    ...
    <article class="flex flex-col shadow my-4">
        <!-- Article Image -->
        <a href="#" class="hover:opacity-75">
            <img src="https://source.unsplash.com/collection/1346951/1000x500?sig=3" alt="article_image" width="1280" height="720">
        </a>
        <div class="bg-white flex flex-col justify-start p-6">
